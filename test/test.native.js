...
var data = require( '@stdlib/math-base-special-ahaversin-test-fixtures-julia-data.json' );
var smallPositive = require( '@stdlib/math-base-special-ahaversin-test-fixtures-julia-small_positive.json' );
