...
```javascript
import ahaversin from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-ahaversin@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-base-special-ahaversin/tags). For example,

```javascript
import ahaversin from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-ahaversin@v0.3.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-ahaversin/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/math-base-special-ahaversin/actions/workflows/test.yml?query=branch:v0.3.0
