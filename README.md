...
```javascript
import ahaversin from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-ahaversin@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-ahaversin/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/math-base-special-ahaversin/actions/workflows/test.yml?query=branch:v0.2.0
